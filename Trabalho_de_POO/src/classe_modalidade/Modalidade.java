...
public abstract class Modalidade {
	 protected Vector<Estudante> estudantes = new Vector<Estudante>();
	 protected int vagas;
	 protected String name;
	 
	 public Modalidade(int vagas) {
	        setVagas(vagas);
	 }
	...
	public abstract Boolean verificaRenda(Estudante e);
    public abstract Boolean verificaEscolaPublica(Estudante e);
    public abstract Boolean verificaPPI(Estudante e);
    public abstract Boolean verificaPcD(Estudante e);
